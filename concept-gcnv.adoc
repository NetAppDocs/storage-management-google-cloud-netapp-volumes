...
NOTE: To start working with Google Cloud NetApp Volumes, you must have the appropriate permissions and the Google Cloud NetApp Volumes admin or Google Cloud NetApp viewer role assigned to you. link:task-add-roles.html[Assign access roles for NetApp Volumes^].
