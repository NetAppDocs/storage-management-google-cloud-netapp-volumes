...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png[Two] link:task-add-roles.html[Assign roles]

[role="quick-margin-para"]
From the NetApp Console, assign the correct roles to members.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png[Three] link:task-create-working-env.html[Add a system]
