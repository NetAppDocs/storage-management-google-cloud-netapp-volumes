...
NOTE: You can use the Google Cloud console or the gcloud CLI for these tasks. To use the gcloud CLI, you must have link:https://cloud.google.com/sdk/docs/install-sdk[installed the Google Cloud CLI^] first.
