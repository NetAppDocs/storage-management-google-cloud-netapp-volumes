...
NOTE: Throughout this procedure, you can use either the Google Cloud console or the gcloud CLI. If you want to use the gcloud CLI, link:https://cloud.google.com/sdk/docs/install-sdk[install the Google Cloud CLI^] first.
